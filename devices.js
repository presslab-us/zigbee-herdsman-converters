...
const pl = {
    overswitch: {
        ...
        fromZigbee: [
            fz.command_on, fz.command_off, fz.command_move, fz.command_stop, fz.illuminance, fz.temperature, fz.battery,
        ],
        toZigbee: [],
...
const devices = [
    ...
    },
    {
        ...
        exposes: [e.battery(), e.action(['single', 'double', 'triple', 'quadruple', 'hold', 'release']), e.voltage()],
        toZigbee: [],
    },
    {
